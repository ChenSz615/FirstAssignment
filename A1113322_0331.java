...
public class A1113322_0331{
    public static void main(String [] args){
        ...
        if(ay==0){
            System.out.println("奔跑距離為:"+a.distance1(ax)); 
        }else{
            System.out.println("奔跑距離為:"+ a.distance2(ax,ay));
        }   
        ...
        if(by==0){
            System.out.println("奔跑距離為:"+b.distance1(bx)); 
        }else{
            System.out.println("奔跑距離為:"+ b.distance2(bx,by));
        } 
        ...
        if(cy==0){
            System.out.println("奔跑距離為:"+c.distance1(cx)); 
        }else{
            System.out.println("奔跑距離為:"+ c.distance2(cx,cy));
        } 
        ...
        if(dy==0){
            System.out.println("奔跑距離為:"+d.distance1(dx)); 
        }else{
            System.out.println("奔跑距離為:"+ d.distance2(dx,dy));
        } 
        ...
        if(ey==0){
            System.out.println("奔跑距離為:"+e.distance1(ex)); 
        }else{
            System.out.println("奔跑距離為:"+ e.distance2(ex,ey));
        } 
        ...
        if(fy==0){
            System.out.println("奔跑距離為:"+f.distance1(fx)); 
        }else{
            System.out.println("奔跑距離為:"+ f.distance2(fx,fy));
        } 
